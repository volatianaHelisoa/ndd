	...
	<div class="form-group">
		...
		<div class="col-md-8">
			<select name="id_domaine" class="form-control">
				...
				{
					$selected = ($t_domaine['id'] == $this->input->post('id_domaine')) ? ' selected="selected"' : "";
	...
	<div class="form-group">
		...
		<div class="col-md-8">
			<select name="id_ip" class="form-control">
				...
				{
					$selected = ($t_ip['id'] == $this->input->post('id_ip')) ? ' selected="selected"' : "";
	...
	<div class="form-group">
		...
		<div class="col-md-8">
			<select name="id_theme" class="form-control">
				...
				{
					$selected = ($t_theme['id'] == $this->input->post('id_theme')) ? ' selected="selected"' : "";
