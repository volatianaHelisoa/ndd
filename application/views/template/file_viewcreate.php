					...
					<h3><strong>UPLOAD LOGO CUSTOMER</strong></h3>
						<div class="center_blccreate upload">
							<div class="formfields">
									...
									<?php echo form_open_multipart('users/do_uploadcreate/'. $user);?>
										<div class="uploadform">
											...
											<div class="custom-inputfile">
												<?php echo "<input id='inputupload' class='inputfiles inputfiles-1' type='file' required name='userfile' size='20' />"; ?>
