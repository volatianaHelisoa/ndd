						...
						<div class="center_blc no-border">
							<div class="formfields">
								<div class="done-request">
									...
									<span class="ltl-consign messlab"><i class="fa fa-3x fa-info-circle"></i>Your file was successfully uploaded!</span>
									<div class="btn-submit">
									<input type="submit" class="messok" value="Ok" onclick="window.location.href='<?php echo base_url(); ?>users/createuserconfirmation/?hash=<?php echo $url;?> '">
									</div>				
								</div>
							</div>
						</div>
