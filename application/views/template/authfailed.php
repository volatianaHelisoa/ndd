				...
				<div class="center_blc resetmessage">
					<div class="formfields">
						<div class="done-request">
							...
							<span class="ltl-consign messlab"><i class="fa fa-3x fa-info-circle"></i>Invalid username or password.<br> Please clic on the button bellow to go to the login page.</span>
