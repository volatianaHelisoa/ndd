...
<?php
$sessuserdata = $this->session->get_userdata('querystring');

$querystring = '';
if(isset($sessuserdata['querystring']) && !empty($sessuserdata['querystring']))
	$querystring = '?' . $sessuserdata['querystring'];
			...
			<div class="rowpad">
				<div id="divisionContent">
					<div class="wrapper-onglet">
						...
						<div class="right usr-create">
							<a href="<?php echo base_url(); ?>actualites" title="News" class="green-btn ">News</a>
						</div>
						<div class="right usr-create">
							<a href="<?php echo base_url(); ?>users" title="Customer" class="green-btn no-active">Customer</a>
						</div>
					</div>
					<!-- top panel -->
						...
						<div class="center_blc no-border">
							<div class="formfields">
								<div class="done-request">
									...
									<span class="ltl-consign messlab"><i class="fa fa-3x fa-info-circle"></i>Actualite(s) has been sucessfully deleted !</span>
									<div class="btn-submit">
									<input type="submit" class="messok" value="Ok" onclick="window.location.href='<?php echo base_url() . 'actualites/' . $querystring; ?>'">
									</div>				
								</div>
							</div>
						</div>
