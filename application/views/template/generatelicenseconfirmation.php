...
<head>
  <meta charset="utf-8">
  <title>Trigger - Edit customer</title>
						...
						<div class="center_blc no-border">
							<div class="formfields">
								<div class="done-request">
									...
									<span class="ltl-consign messlab"><i class="fa fa-3x fa-info-circle"></i>License file has been successfully  generated !</span>
									...
									<input type="submit" class="messok" value="Ok" onclick="window.location.href='<?php echo base_url(); ?>users/edit/<?php $id=$_GET['hash'];echo $id; ?>'">
									</div>				
								</div>
							</div>
						</div>
