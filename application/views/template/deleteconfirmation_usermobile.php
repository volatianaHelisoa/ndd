				...
				<div id="divisionContent">
					<div class="wrapper-onglet">
						<div class="right usr-create">
							<a href="<?php echo base_url(); ?>usermobile" title="Users" class="green-btn">Users</a>
						</div>
						<div class="right usr-create">
						...
						<div class="center_blc no-border">
							<div class="formfields">
								<div class="done-request">
									...
									<span class="ltl-consign messlab"><i class="fa fa-3x fa-info-circle"></i>User(s) has been sucessfully deleted !</span>
									<div class="btn-submit">
									<input type="submit" class="messok" value="Ok" onclick="window.location.href='<?php echo base_url(); ?>usermobile'">
									</div>				
								</div>
							</div>
						</div>
